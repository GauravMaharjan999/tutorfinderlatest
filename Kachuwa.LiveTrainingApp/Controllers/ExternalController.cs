...
namespace Auth.OnlineKachhya.Controllers
{
    ...
    public class ExternalController : Controller
    {
        ...
        private async Task<IdentityUser> AutoProvisionUser(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
            ...
            // return user;
            //await _appUserService.AddExternalUser(provider, providerUserId, claims.ToList());
            var user = await _userManager.FindByLoginAsync(provider, providerUserId);
            return user;
        }
