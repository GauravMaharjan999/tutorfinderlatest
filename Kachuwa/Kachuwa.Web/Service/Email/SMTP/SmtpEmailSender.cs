    ...
    public class SmtpEmailSender : IEmailSender
    {
            ...
            string html)
        {
...

            {
                ...
                var message = new MailMessage { From = new MailAddress("gauravmaharjan.infodev@gmail.com", @from.DisplayName ?? "") };
                ...
                var smtpclient = new SmtpClient
                {
                    ...
                    Host = "smtp.gmail.com",
                    Port = 587,
                    Credentials = new System.Net.NetworkCredential("gauravmaharjan.infodev@gmail.com", "frxjvomxlkgvrmcm"),
                    EnableSsl = true
                };
