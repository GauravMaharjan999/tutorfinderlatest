...
namespace CourseRecommendation.DataStructures
{
    class Course
    {
        ...
        private static String coursesdatasetRelativepath = $"{Program.DatasetsRelativePath}/courses.csv";
        private static string coursesdatasetpath = Program.GetAbsolutePath(coursesdatasetRelativepath);
