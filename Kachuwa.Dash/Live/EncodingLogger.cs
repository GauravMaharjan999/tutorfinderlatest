...
namespace Kachuwa.Dash.Live
{
    public class EncodingLogger : ILogger
    {
        ...
        private System.IO.Stream GetRatesFileStream()
        {
            return File.Open(LogFilePath, FileMode.Append, FileAccess.Write);
        }

        private void WriteLog(string log, System.IO.Stream stream)
        {
